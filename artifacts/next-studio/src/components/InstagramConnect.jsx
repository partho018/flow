    ...
    return (
      <div className="fixed inset-0 z-[200] bg-background/80 backdrop-blur-sm flex items-center justify-center p-6 overflow-hidden">
        ...
        <motion.div 
          ...
          className="relative z-10 bg-card border border-border p-10 rounded-[40px] shadow-2xl max-w-sm w-full text-center space-y-8"
        >
          ...
          <button 
            onClick={onBack}
            className="w-full py-4 bg-primary text-primary-foreground rounded-2xl font-black text-sm shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
          >
            Next
          </button>
        </motion.div>
        ...
        <motion.div 
          ...
          className="absolute bottom-10 right-10 flex items-center gap-3 px-5 py-3 bg-white border-l-4 border-green-500 rounded-lg shadow-2xl z-50"
        >
  ...
  return (
    <div className="fixed inset-0 z-[200] bg-background flex flex-col items-center justify-center p-6 overflow-y-auto">
      <div className="max-w-[340px] w-full space-y-7 py-10">
        ...
        {/* Info Card */}
        <div className="bg-muted/30 border border-border rounded-[28px] p-6 space-y-4">
        ...
        <div className="space-y-5 text-center">
           <a 
             href={connectUrl}
             className="flex items-center justify-center gap-2.5 w-full py-3.5 bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] text-white rounded-xl font-black text-xs shadow-lg shadow-red-500/10 hover:brightness-110 transition-all"
           >
             <Instagram size={16} />
